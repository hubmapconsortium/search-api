    ...
    {'anatomy_0': ['body'],
     ...
     'donor': {'mapped_metadata': {'sex': ['Male']},
               'metadata': {'organ_donor_data': [{'data_type': 'Nominal',
                                                  ...
                                                  'preferred_term': 'Male'}]}},
     'entity_type': 'dataset',
     'files': [{'description': 'Cells Sets JSON',
                'mapped_description': 'Cells Sets JSON (JSON file)',
                'rel_path': 'cluster-marker-genes/output/cluster_marker_genes.cell-sets.json'},
               {'description': 'Cells JSON',
                'mapped_description': 'Cells JSON (JSON file)',
                'rel_path': 'cluster-marker-genes/output/cluster_marker_genes.cells.json'}],
     'group_name': 'EXT - Outside HuBMAP',
     ...
     'vitessce': {'coordinationSpace': {'dataset': {'A': 'A'},
                  ...
                  'datasets': [{'files': [{'fileType': 'cells.json',
                                           'type': 'cells',
                                           'url': 'http://example.com/fake-assets/0123456789abcdef0123456789abcdef/cluster-marker-genes/output/cluster_marker_genes.cells.json?token=REPLACE_WITH_GROUPS_TOKEN'},
                                          {'fileType': 'cell-sets.json',
                                           'type': 'cell-sets',
                                           'url': 'http://example.com/fake-assets/0123456789abcdef0123456789abcdef/cluster-marker-genes/output/cluster_marker_genes.cell-sets.json?token=REPLACE_WITH_GROUPS_TOKEN'}],
