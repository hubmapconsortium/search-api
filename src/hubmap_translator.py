...
class Translator(TranslatorInterface):
    ...
    def __init__(self, indices, app_client_id, app_client_secret, token, ontology_api_base_url:str=None):
        ...
        # Load a list of entity attributes which either come from Neo4j or are generated by entity-api, and
        # should be stored on an OpenSearch document for the entity. Attributes may be renamed for storage in
        # OpenSearch, and attributes not specified in the list are not retained in the OpenSearch document.
    ...
    def translate_upload(self, entity_id, reindex=False):
        try:
            ...
            self._entity_keys_rename_and_retain(upload)
    ...
    def translate_collection(self, entity_id, reindex=False):
        ...
        try:
            ...
            self._entity_keys_rename_and_retain(collection)
    ...
    # Given a dictionary for an entity containing Neo4j and entity-api-generated fields, return a
    # dictionary containing only the fields which will go into an OpenSearch document, with keys renamed to
    # correspond to OpenSearch document field names.
    def _entity_keys_rename_and_retain(self, entity):
        logger.info("Start executing _entity_keys_rename_and_retain()")
        ...
        logger.info("Finished executing _entity_keys_rename_and_retain()")
